            ...
            <nav className="bg-white z-[1] h-[5rem] lg:h-[8rem] w-full flex justify-between items-center lg:absolute lg:top-[3.2rem] px-[2.287rem] lg:px-[11.2rem] bg-transparent fixed">
                ...
                <section>
                    <section>
                        ...
                        <section className={hamburgerStyles} onClick={toggleMenu}>
                            <section className="h-[0.188rem] bg-[#292D32] rounded-[5px] gen-transistion"></section>
                            <section className="h-[0.188rem] bg-[#292D32] rounded-[5px]"></section>
                            <section className="h-[0.188rem] bg-[#292D32] rounded-[5px] gen-transistion"></section>
                            <section className="fixed top-[5rem] left-[0] w-full bg-[#f2f2f2] p-[1rem]">
                                <ul className="">
                                    <li className="h-[4rem] center"><NavLink to="/" className={activeLinkStyle}>Home</NavLink></li>
                                    <li className="h-[4rem] center"><NavLink to="/about" className={activeLinkStyle}>About</NavLink></li>
                                    <li className="h-[4rem] center"><NavLink to="/ecotips" className={activeLinkStyle}>EcoTips</NavLink></li>
                                    <li className="h-[4rem] center"><NavLink to="/contact" className={activeLinkStyle}>Contact</NavLink></li>
                                </ul>
                                <ul className="">
                                    <li className="h-[4rem] center" onClick={() => setIfClickSignIn(true)}>{<NavLink to="/login">Sign in</NavLink>}</li>
                                    <li className="center">—</li>
                                    <li className="h-[4.3rem] center" onClick={() => setIfClickSignIn(false)}>{<NavLink to="/login"><GreenButton className="p-[1rem]">Sign up</GreenButton></NavLink>}</li>
                                </ul>
                            </section>
                        </section>
                    </section>
