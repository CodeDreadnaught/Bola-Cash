...
const Header = () => {
    ...
    hamburgerStyles = showMobileNavigation ? "hamburger-icon w-[3rem] h-[3rem] py-[0.781rem] px-[0.281rem] flex flex-col justify-between md:hidden active" : "hamburger-icon w-[3rem] h-[3rem] py-[0.781rem] px-[0.281rem] flex flex-col justify-between md:hidden";
    ...
    return (
        <header>
            <nav className="bg-white z-[1] h-[5rem] md:h-[8rem] w-full flex justify-between items-center md:absolute md:top-[3.2rem] px-[2.287rem] md:px-[11.2rem] bg-transparent fixed">
                <section>
                    <NavLink to="/"><section className="w-[2.96rem] h-[3rem] md:w-[4.934rem] md:h-[5rem]"><img src={BolaCashLogo} alt="Bola Cash Logo" className="size-full" /></section></NavLink>
                </section>
                <section>
