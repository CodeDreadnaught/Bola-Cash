        ...
        <HelmetProvider>
            <main>
                ...
                <div className="lg:flex items-center lg:gap-[3rem] relative">
                    ...
                    <img src={RecycleBackground} alt="Background Fading Image" className="recycle-image absolute hidden top-[168%] opacity-5 z-[-1] lg:block object-cover scale-[1.5]" />
                </div>
